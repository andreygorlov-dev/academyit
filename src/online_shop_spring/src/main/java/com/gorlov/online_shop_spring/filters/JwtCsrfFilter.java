package com.gorlov.online_shop_spring.filters;
...
public class JwtCsrfFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        boolean isNotFilter = request.getMethod().equals("GET") || (request.getMethod().equals("POST") && request.getServletPath().contains("/user"));
        ...
        if (isNotFilter) {//Смотреть можно смотреть и без регистрации!!!
